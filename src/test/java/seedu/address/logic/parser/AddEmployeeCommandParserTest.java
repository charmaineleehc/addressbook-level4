...
public class AddEmployeeCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Employee expectedEmployee = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
        ...
        Employee expectedEmployeeMultipleTags = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Employee expectedEmployee = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
